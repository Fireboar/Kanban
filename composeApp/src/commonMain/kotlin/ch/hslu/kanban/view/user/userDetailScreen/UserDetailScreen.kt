package ch.hslu.kanban.view.user.userDetailScreen
...
fun UserDetailScreen(
    ...
    val isOwnUser =
        user?.userId == userViewModel.currentUser.collectAsState().value?.userId
            ...
            Column(
                ...
                Button(
                    enabled = newPassword.length >= 8
                            && (isOwnUser.not() || oldPassword.isNotBlank()),
                    onClick = {
